...
const legacySearchQuery = require('../../GDS/querys/legacySearch');
...
// Test
test('Get Legacy Search', async ({ request, baseURL }) => {
  const dateRangeBefore = process.env.dateRangeBefore;
  const dateRangeAfter = process.env.dateRangeAfter;
